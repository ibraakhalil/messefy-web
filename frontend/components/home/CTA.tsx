const CTA = () => {
  return (
    <section className="relative overflow-hidden border-t border-gray-100 py-16 sm:py-20 dark:border-gray-900">
      ...
      <div className="container max-w-5xl text-center">
        ...
        <p className="reveal mt-3 text-gray-600 dark:text-gray-300">
        ...
        <div className="reveal mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            href="#"
            className="inline-flex items-center gap-2 rounded-lg border border-gray-200 px-6 py-3 text-sm font-semibold text-gray-800 hover:bg-gray-50 dark:border-gray-800 dark:text-gray-200 dark:hover:bg-gray-900"
          >
            Book a demo
          </a>
        </div>
