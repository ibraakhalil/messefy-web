...
export default async function MessPage() {
  ...
  return (
    <PageWrapper>
      ...
      <header className="my-8 rounded-xl border border-border-color bg-card-bg p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="tablet:flex-row tablet:items-center tablet:justify-between tablet:space-y-0 flex flex-col space-y-4">
          <div className="flex items-center space-x-4">
            <div className="flex size-14 items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 text-2xl font-bold text-white shadow-md">
              {userData.workspace?.name?.charAt(0)}
            </div>
            <div className="space-y-1">
              <div className="flex items-center space-x-3">
                <h1 className="text-2xl font-semibold text-pure-color dark:text-white">
